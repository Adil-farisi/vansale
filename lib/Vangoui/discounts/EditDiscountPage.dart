...
class _EditDiscountPageState extends State<EditDiscountPage> {
  ...
  late TextEditingController _discountDateController;
  ...
  void initState() {
    ...
    _customerNameController = TextEditingController(
      text: widget.discount['customerName'],
    );
    _dueAmountController = TextEditingController(
      text: '₹2,500', // Hardcoded due amount (read-only)
    );
    _discountDateController = TextEditingController(
      text: widget.discount['date'],
    );
    _discountAmountController = TextEditingController(
      text: widget.discount['discountAmount'].toString().replaceAll('₹', ''),
    );
    _notesController = TextEditingController(
      text: widget.discount['notes'],
    );
  }
